// use crate::devices::{SmartSocket, SmartThermometer, DeviceStatePrinter, DeviceType, DeviceInfo};
// use crate::smart_house_mod::{SmartHouse, Apartment};

// pub mod devices;
// pub mod smart_house_mod;

fn main() {
    println!("Hello Smart Home");
    // let smart_socket1: Box<dyn DeviceStatePrinter> = Box::new(SmartSocket {
    //     info: DeviceInfo {
    //         id: 0,
    ...
    //     current_power: 0,
    // });
    // let smart_socket1_2: Box<dyn DeviceStatePrinter> = Box::new(SmartSocket {
    //     info: DeviceInfo {
    //         id: 0,
    ...
    //     current_power: 230,
    // });
    // let smart_socket2: Box<dyn DeviceStatePrinter> = Box::new(SmartSocket {
    //     info: DeviceInfo {
    //         id: 0,
    //         name: "Smart Socket 2".to_string(),
    //         device_type: DeviceType::PowerSocket,
    ...
    //     current_power: 220,
    // });
    // let therm: Box<dyn DeviceStatePrinter> = Box::new(SmartThermometer {
    //     info: DeviceInfo {
    //         id: 0,
    ...
    //     temperature: 20,
    // });
    // let bedroom = Apartment::from_vec(1, vec![smart_socket1.get_name(), smart_socket1_2.get_name()]);
    // let living_room = Apartment::from_vec(2, vec![smart_socket2.get_name(), therm.get_name()]);
    // let smart_house = SmartHouse::new("Cottage", vec![bedroom, living_room]);
    // println!("Rooms List:\t");
    // for room in smart_house.get_apartments() {
    //     print!("{}:\t", room);
    //     smart_house
    //         .devices(room)
    //         .into_iter()
